...
//        TextView weatherDateTV = (TextView)view.findViewById(R.id.list_item_date_textview);
//        weatherDateTV.setText(Utility.getFriendlyDayString(context, weatherDate));
...
//        TextView weatherMinTempTV = (TextView)view.findViewById(R.id.list_item_low_textview);
//        weatherMinTempTV.setText(Utility.formatTemperature(low, isMetric));
